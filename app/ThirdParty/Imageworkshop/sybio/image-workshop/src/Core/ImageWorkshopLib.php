...
class ImageWorkshopLib
{
    ...
    public static function convertHexToRGB($hex)
    {
		if ($hex) {
			...
			return array ('R' => (int) $red, 'G' => (int) $green, 'B' => (int) $blue); 
		} else {
    ...
    {
		$destinationPosX = (int) $destinationPosX;
		$destinationPosY = (int) $destinationPosY;
		$sourcePosX = (int) $sourcePosX;
		$sourcePosY = (int) $sourcePosY;
