				...
				<div class="row mb-3">
					...
					<div class="col-sm-8">
						<?=options(['name' => 'generate_permission']
									, ['otomatis' => 'Otomatis (CRUD)', 'otomatis_own' => 'Otomatis (CRUD Own)', 'otomatis_all_own' => 'Otomatis (CRUD + CRUD Own)', 'manual' => 'Manual']
									, set_value('generate_permission', @$generate_permission) 
								)?>
						<small>Otomatis: otomatis akan membuat permission untuk CRUD, yaitu: create, read_all, update_all, delete_all (jika permission sudah ada, maka tidak akan dibuat). CRUD Own berarti read_own, update_own, dan delete_own</small>
					</div>
				</div>
				<?php
